...
import (
	...
	xgboostv1beta1 "github.com/kubeflow/xgboost-operator/pkg/apis/xgboost/v1beta1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &xgboostv1beta1.XGboostJob{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &xgboostv1beta1.XGboostJob{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=xgboost.github.com,resources=xgboostjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=xgboost.github.com,resources=xgboostjobs/status,verbs=get;update;patch
func (r *ReconcileXGboostJob) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the XGboostJob instance
	instance := &xgboostv1beta1.XGboostJob{}
